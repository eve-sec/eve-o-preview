...
namespace EveOPreview.View
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			TitleMenuItem.Text = "EVE-O Preview M4O Edition";
			// 
			// SeparatorMenuItem
			// 
			...
			NameLabel.Text = "EVE-O Preview M4O Edition";
			// 
			// DocumentationLink
			// 
    ...
    "be set from prresenter";
			...
			this.NotifyIcon.Text = "EVE-O Preview M4O Edition";
			...
			this.Name = "MainForm";
			this.Text = "EVE-O Preview M4O Edition";
			this.TopMost = true;
